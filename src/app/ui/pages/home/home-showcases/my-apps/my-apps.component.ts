...
export class MyAppsComponent implements OnInit {
  ...
  _mApps : AppType[] = [
    {
      "id": "5132",
      "name": "FieldEquip: Field Management Software",
      "image": "assets/img/apps/fieldequip.png",
      "link": "https://fieldequip.com/",
      "tab": "Android",
      "isFull": false,
      "caption": "In Web App",
      "background":"#F5E7B4"
    ...
    {
     "id": "5131",
     "name": "E-commerce: Shop for Home",
     "image": "assets/img/apps/shopforhome.png",
     "link": "",
     "tab": "Android",
     "caption": "Application like blinkit",
     "isFull": false,
     "primary":"#3FD67D",
     "background":"#E1E1E1"
   },
   ...
   {
     "id": "5133",
     "name": "QR Base : Record Attendence",
     "image": "assets/img/apps/qrbase.png",
     "link": "",
     "tab": "Android",
     "caption": "In Mern Stack",
     "isFull": true,
     "background":"#3CE79F"
   }
  ];
